...
public class FavoriteController {
    ...
    public ResponseEntity<FavoriteMovie> addMovie( @PathVariable Long movieId) {
    ...
    public ResponseEntity<FavoriteSeries> addSeries(@PathVariable Long seriesId) {
    ...
    public ResponseEntity<Void> removeSeries( @PathVariable Long seriesId) {
        favoriteService.removeSeries(seriesId);
        return ResponseEntity.noContent().build();
    }

    @GetMapping("/series")
    public ResponseEntity<List<FavoriteSeries>> getFavoriteSeries() {
